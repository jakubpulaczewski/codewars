...
The link: https://www.codewars.com/kata/551dc350bf4e526099000ae5
...
and between words (at least one between any pair of neighbouring words), and then the boy glues together all the words, including "WUB", in one string and plays 
...
Examples:
  ...
  (The input is  WE ARE THE CHAMPIONS MY FRIEND)
"""
